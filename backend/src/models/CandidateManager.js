...
class CandidateManager extends AbstractManager {
  ...
  //   try {
  //     const resultOne = await this.database.query(updateQuery1, [
  //       candidate.lastname,
  //       candidate.firstname,
  //       candidate.birthdate,
  //       candidate.id,
  ...
  //     const resultTwo = await this.database.query(updateQuery2, [
  ...
  //     const resultThree = await this.database.query(updateQuery3, [
